...
public class Constants {
	public static final String CWE_EVENT_SOURCE = "SengamesWebService";
	public static final String GAME_START_MESSAGE_FORMAT = "A new round of %s is starting in %d seconds. Get ready to join!";
